...
abstract class EspIdfProvisioningSpec(context: ReactApplicationContext?) : ReactContextBaseJavaModule(context) {
    ...
    abstract fun createESPDevice(deviceName: String, transport: String, security: Int, address: String?, primaryServiceUuid: String?, proofOfPossesion: String?, softAPPassword: String?, username: String?, promise: Promise?)
